/**
 * @file Mixed read/write load test with API key authentication
 */
package main
...
func main() {
	...
	log.Printf("Starting mixed load test (API Key Auth) for %v...", testDuration)
	...
	log.Println("\n--- Mixed Load Test Summary (API Key Auth) ---")
